...
export function ArticleSection({ posts, galleryItems = [], galleryLoading = false, galleryError = '', loading, error = '', headingLevel = 'h2', limit, moreLink, surfaceOpacity }: ArticleSectionProps) {
  ...
  return <section id="articles" className={`content-section article-section${surfaceOpacity === undefined ? '' : ' home-surface'}`} aria-labelledby="articles-heading" style={surfaceOpacity === undefined ? undefined : { '--surface-opacity': surfaceOpacity } as React.CSSProperties}>
